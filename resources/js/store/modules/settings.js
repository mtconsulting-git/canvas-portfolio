...
const initialState = {
  ...
  portfolioEnabled: window.Canvas.portfolioEnabled,
  blogEnabled: window.Canvas.blogEnabled,
  languages: window.Canvas.languages,
  google_translate: window.Canvas.google_translate,
};

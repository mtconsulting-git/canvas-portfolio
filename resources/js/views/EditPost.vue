    ...
    <main v-if="isReady" class="py-4">
      <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12">
        ...
        <div class="form-group my-2">
          <quill-editor :key="post.id" :post="post" :language-selected="languageSelected" @update-post="savePost"/>
        </div>
      </div>
    </main>
...
export default {
  ...
  methods: {
    fetchPost() {
      return this.request()
          ...
          .then(({data}) => {
            ...
            this.post.meta.description.it = get(data.post.meta, 'description.it', '');
            this.post.meta.description.en = get(data.post.meta, 'description.en', '');
            this.post.meta.description.es = get(data.post.meta, 'description.es', '');
            this.post.meta.description.fr = get(data.post.meta, 'description.fr', '');
            this.post.meta.description.de = get(data.post.meta, 'description.de', '');
            ...
            this.post.meta.canonical_link.it = get(data.post.meta, 'canonical_link.it', '');
            this.post.meta.canonical_link.en = get(data.post.meta, 'canonical_link.en', '');
            this.post.meta.canonical_link.es = get(data.post.meta, 'canonical_link.es', '');
            this.post.meta.canonical_link.fr = get(data.post.meta, 'canonical_link.fr', '');
            this.post.meta.canonical_link.de = get(data.post.meta, 'canonical_link.de', '');
    ...
    async savePost() {
      ...
      this.isSaving = true;
      this.isSaved = false;
      this.post.title[this.languageSelected] = this.post.title[this.languageSelected] || 'Title';

            ...
            <template slot="options">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <router-link :to="{ name: 'create-portfolio_category' }" class="dropdown-item">
            ...
            <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12">
                ...
                <div v-if="isReady" class="mt-5 card shadow-lg">
                    <div class="card-body p-0">
                        <div :key="`${index}-${portfolio_category.id}`" v-for="(portfolio_category, index) in portfolio_categories">
                            <router-link
                                :to="{
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-auto d-none d-md-inline-block">
                                            <span class="text-secondary mr-3"
                                                ...
                                                {{ portfolio_category.portfolios_count == 1 ? trans.portfolios : trans.portfolios }}</span
                                            >
                                            <span class="mr-3"
                                                >{{ trans.created }}
                                                {{ moment(portfolio_category.created_at).format('MMM D, YYYY') }}</span
                                            >
                                        </div>

            ...
            <template slot="options">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <router-link :to="{ name: 'create-portfolio' }" class="dropdown-item">
                            {{ trans.new_portfolio }}
                        </router-link>
                    </div>
                </div>
        ...
        <main v-if="isReady" class="py-4">
            <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12">
                <div class="d-flex justify-content-between mt-2 mb-4 align-items-end">
                    <h3 class="mt-2">{{ trans.portfolios }}</h3>
                ...
                <div class="mt-5 card shadow-lg">
                    <div class="card-body p-0">
                            ...
                            >
                                ...
                                >
                                    <div class="pl-2 col-md-8 col-sm-10 col-10 py-1">
                                        ...
                                        <p v-if="portfolio.summary" class="text-truncate text-secondary my-1">
                                            {{ portfolio.summary.it }}
                                        </p>
                                        <p class="text-secondary mt-1 mb-0">
                                            <span v-if="isPublished(portfolio.published_at)">
                                                {{ trans.published }}
                                                {{ moment(portfolio.published_at).fromNow() }}
                                            </span>

                                            <span v-if="isDraft(portfolio.published_at)" class="text-danger">{{
                                                trans.draft
                                            }}</span>
                                    ...
                                    <div class="ml-auto d-none d-md-inline pl-3">
                                        <div
                                            ...
                                            :style="{
                                                backgroundImage: 'url(' + portfolio.featured_image + ')',
                                            }"
                                        />
                        ...
                        <infinite-loading :identifier="infiniteId" spinner="spiral" @infinite="fetchPortfolios">
                            <span slot="no-more" />
                            <div slot="no-results" class="text-left">
                                <div class="my-5">
                                    <p class="lead text-center text-muted mt-5">
                                        <span v-if="type === 'published'">{{ trans.you_have_no_published_portfolios }}</span>
                                        <span v-else>{{ trans.you_have_no_draft_portfolios }}</span>
                                    </p>

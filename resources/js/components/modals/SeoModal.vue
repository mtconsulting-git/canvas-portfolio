        ...
        <div class="modal-body">
          <div class="form-group row">
            <div class="col-12">
              ...
              <input
                v-model="post.meta.title[this.languageSelected]"
                id="title"
                name="title"
                type="text"
          ...
          <div class="form-group row">
            <div class="col-12">
              ...
              <textarea
                v-model="post.meta.description[this.languageSelected]"
                id="description"
                rows="4"
                name="description"
                style="resize: none"
          ...
          <div class="form-group row">
            <div class="col-12">
              ...
              <input
                v-model="post.meta.canonical_link[languageSelected]"
                id="canonical_link"
                type="text"
                class="form-control border-0"
                name="canonical_link"
...
export default {
  ...
  methods: {
    syncTitle() {
      this.$emit("sync-title", this.post.title[this.languageSelected]);
      this.update();
    },

    syncDescription() {
      this.$emit("sync-description", this.post.summary[this.languageSelected]);
      this.update();
    },

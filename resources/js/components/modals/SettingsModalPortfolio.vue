    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
            <div class="col-12">
              <label class="font-weight-bold text-uppercase text-muted small">{{ trans.portfolio_categories }}</label>
              <multiselect
          ...
          <div class="form-group row">
            <div class="col-12">
              <label for="project_name" class="font-weight-bold text-uppercase text-muted small">
                {{ trans.project_name }}
              </label>
              <input
          ...
          <div class="form-group row">
            <div class="col-12">
              <label for="location" class="font-weight-bold text-uppercase text-muted small">
                {{ trans.location }}
              </label>
              <input
          ...
          <div v-if="languageSelected === 'it'" class="form-group row">
            <div class="col-12">
              <label for="year" class="font-weight-bold text-uppercase text-muted small">
                {{ trans.year }}
              </label>
              <input
          ...
          <div v-if="languageSelected === 'it'" class="form-group row">
            <div class="col-12">
              <label for="company" class="font-weight-bold text-uppercase text-muted small">
                {{ trans.company }}
              </label>
              <input

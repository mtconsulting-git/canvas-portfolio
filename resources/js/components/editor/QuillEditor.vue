...
export default {
    ...
    async mounted() {
        ...
        this.editor.on('text-change', () => {
            ...
            this.post.body[this.languageSelected] = this.editor.getText() ? this.editor.root.innerHTML : '';
            this.update();
        });
    },
    ...
    methods: {
        ...
        handleEditorValue() {
            return (this.editor.root.innerHTML = this.post.body[this.languageSelected]);
        },
